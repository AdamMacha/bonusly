...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-navy">
      ...
      {/* Green glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-green/5 blur-[120px]" />
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28 lg:py-36">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-4 py-1.5 mb-8">
            ...
            <span className="text-xs text-slate-400 font-medium">Ověřené nabídky · Pravidelně aktualizujeme</span>
          </div>
